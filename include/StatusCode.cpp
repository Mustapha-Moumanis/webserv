...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/03/19 16:57:59 by mmoumani          #+#    #+#             */
/*   Updated: 2024/03/19 17:03:06 by mmoumani         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool HttpStatus::isVadilCode(int code) {
    return (code >= 100 && code < 600);
}

const char * HttpStatus::reasonPhrase(StatusCode code) {
    switch (code) {
        case 0:   return "None";
